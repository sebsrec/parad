...
void Arena::enterArena(Monster *monster) {
    ...
    if (arenaType == "hell" && dynamic_cast<FireMonster *>(monster) != nullptr) {
        ...
        std::cout << ">> ARENA BONUS! Monster " << monster->getName() << " entered the Hell arena and gained 50 extra health.\n";

    } else if (arenaType == "ocean" && dynamic_cast<WaterMonster *>(monster) != nullptr) {
        monster->increaseHealth(50);
        std::cout << ">> ARENA BONUS! Monster " << monster->getName() << " entered the Ocean arena and gained 50 extra health.\n";
        ...
        monster->increaseHealth(50);
        std::cout << ">> ARENA BONUS! Monster " << monster->getName() << " entered the Eternal Void and gained 50 extra health.\n";
